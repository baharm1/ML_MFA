...
Requirements of R codes can be found in the scripts.
...
The results of modified scFEA (`output`) are visualized in `visualize_modified_scFEA_output.R`. These plots are shown in **Figure 2D-G**.
