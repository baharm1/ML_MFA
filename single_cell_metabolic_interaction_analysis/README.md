...
## Usage
First step is to install MEBOCOST from [its GitHub repository](https://github.com/zhengrongbin/MEBOCOST). Navigate to this folder to install MEBOCOST in the current directory, then run `MEBOCOST_communication_score.ipynb` which utilizes MEBOCOST for communication prediction. This jupyter notebook requires three input files, as follows:
